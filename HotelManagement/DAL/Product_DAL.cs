...
namespace HotelManagement.DAL
{
    class Product_DAL
    {
        public static bool Insert(string name,int price, string details, int quantityStock)
        {
        ...
        public static bool Update(int id , string name, int price, string details, int quantityStock)
        {
